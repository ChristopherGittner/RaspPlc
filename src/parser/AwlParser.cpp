...
AwlParser& AwlParser::getInstance()
{
    static AwlParser instance;
    return instance;
}

std::shared_ptr<Program> AwlParser::parse(std::istream& is, const RaspPlc& plc)
{
